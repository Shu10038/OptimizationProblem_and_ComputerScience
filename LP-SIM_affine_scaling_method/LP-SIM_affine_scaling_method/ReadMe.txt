========================================================================
    コンソール アプリケーション: LP-SIM_affine_scaling_method プロジェクトの概要
========================================================================

この LP-SIM_affine_scaling_method アプリケーションは、AppWizard により作成されました。

このファイルには、LP-SIM_affine_scaling_method アプリケーションを構成する各ファイルの内容の概要が含まれています。


LP-SIM_affine_scaling_method.vcxproj
...
LP-SIM_affine_scaling_method.vcxproj.filters
...
LP-SIM_affine_scaling_method.cpp
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、LP-SIM_affine_scaling_method.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。
